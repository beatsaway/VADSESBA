...
(function () {
  ...
  window.SBA_i18n.mergeStrings({
    "p3c.b01": { en: "<strong>Demonstrates excellence</strong> in manipulating media, skills and techniques / writing skills", ne: "माध्यम, सीप र लेखनमा <strong>उत्कृष्ट नियन्त्रण</strong> देखाउँछ", ur: "میڈیا، مہارتوں اور تحریر میں <strong>بہترین قابو</strong> دکھاتا ہے" },
    ...
    "p3c.b07": { en: "<strong>Demonstrates an exceptional use / analysis</strong> of visual elements and principles of organisation relevant to the theme", ne: "विषयसँग सान्दर्भिक दृश्य तत्व र संगठनका सिद्धान्तको <strong>अपवादात्मक प्रयोग / विश्लेषण</strong> देखाउँछ", ur: "موضوع سے متعلق بصری عناصر اور تنظیم کے اصولوں کا <strong>غیر معمولی استعمال / تجزیہ</strong> دکھاتا ہے" },
    ...
    "p3c.b13": { en: "Indicates <strong>deep knowledge</strong> of personal, aesthetic or cultural context(s) in relation to the theme", ne: "विषयसँग सम्बन्धमा व्यक्तिगत, सौन्दर्य वा सांस्कृतिक सन्दर्भको <strong>गहिरो ज्ञान</strong> देखाउँछ", ur: "موضوع سے متعلق ذاتی، جمالیاتی یا ثقافتی سیاق کا <strong>گہرا علم</strong> ظاہر کرتا ہے" },
    ...
    "p3c.b19": { en: "Demonstrates <strong>imagination, creative and complete ideas</strong> / Expresses <strong>informed personal view(s)</strong> with evidence support or insight", ne: "<strong>कल्पना, सिर्जनशील पूर्ण विचार</strong> / प्रमाण वा अन्तर्दृष्टिसहित <strong>सूचित व्यक्तिगत दृष्टिकोण</strong>", ur: "<strong>تخیل، تخلیقی مکمل خیالات</strong> / ثبوت یا بصیرت کے ساتھ <strong>باخبر ذاتی رائے</strong>" },
    ...
    "p3c.b25": { en: "Communicates the theme or message in an <strong>innovative way</strong> with a coherent and complete presentation", ne: "समग्र प्रस्तुतिसहित <strong>नवप्रवर्तक तरिकाले</strong> विषय वा सन्देश सञ्चार", ur: "مکمل متسق پیشکش کے ساتھ <strong>نئے انداز میں</strong> موضوع یا پیغام پہنچاتا ہے" },
    ...
    "p3c.b31": { en: "Shows <strong>substantial progression</strong>", ne: "<strong>ठूलो प्रगति</strong> देखाउँछ", ur: "<strong>بنیادی پیش رفت</strong> دکھاتا ہے" },
